...
class BSPMainApplicationVi(
    private val eggLabelContext: Context,
    private val BSPCallback: BSPCallBack,
    ...
    private fun eggLabelHandleCreateWebWindowRequest(resultMsg: Message?) {
        ...
        if (resultMsg.obj != null && resultMsg.obj is WebViewTransport) {
            ...
            val windowWebView =
                BSPMainApplicationVi(eggLabelContext, BSPCallback, eggLabelWindow)
            transport.webView = windowWebView
            resultMsg.sendToTarget()
            BSPCallback.feedMixHandleCreateWebWindowRequest(windowWebView)
        }
    }
